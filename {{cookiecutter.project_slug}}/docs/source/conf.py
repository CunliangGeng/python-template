...
version = {{ cookiecutter.module_name.lower().replace(' ', '_').replace('-', '_')}}.__version__
# The full version, including alpha/beta/rc tags.
release = {{ cookiecutter.module_name.lower().replace(' ', '_').replace('-', '_')}}.__version__
...
def run_apidoc(_):
    ...
    src = os.path.abspath(os.path.join(here, '..', '{{ cookiecutter.module_name }}'))
...
texinfo_documents = [
    (master_doc, '{{ cookiecutter.repo_name }}', u'{{ cookiecutter.repo_name }} Documentation',
     author, '{{ cookiecutter.repo_name }}', "{{ cookiecutter.project_short_description.replace('\"', '\\\"') }}",
     'Miscellaneous'),
]
